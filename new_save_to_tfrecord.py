...
def new_run():
	...
	example = save_to_record(cat1_label[0], cat1_label[1], cat1_label[2], cat1_bbox[0], cat1_bbox[1], cat1_bbox[2], cats)
	example = save_to_record(cat2_label[0], cat2_label[1], cat2_label[2], cat2_bbox[0], cat2_bbox[1], cat2_bbox[2], cats)
	example = save_to_record(cat3_label[0], cat3_label[1], cat3_label[2], cat3_bbox[0], cat3_bbox[1], cat3_bbox[2], cats)
